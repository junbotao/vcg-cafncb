function out = ncb_run_generic(cfg)
    ...
    for t=1:T
        for r=1:R
            w0 = mean(cfg.W_edge{t,r},2);
            out.W_node(:,t,r) = cfg.project_fn(w0);
        end
    end
    ...
    for j=1:J
        for t=1:T
            for r=1:R
                ...
                w_center = mean(cfg.W_edge{t,r},2);
                out.W_center(:,t,r) = cfg.project_fn(w_center);
